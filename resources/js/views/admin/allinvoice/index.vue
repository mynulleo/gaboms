                ...
                <table id="pdf-table" class="table">
                    <thead style="">
                        <tr class="tr_stick">
                            ...
                            <th style=""><span class="heading">Source </span></th>
                    ...
                    <tbody>
                        <tr class="td_track change_sorting change_sortingundefined update_item7" title=""
                            ...
                            <td style="">{{ data.source }}</td>
                            <td style="">{{ data.ref_no }}</td>
                            <td style=""><span class="badge bg-warning text-dark">{{ data.date }} </span></td>
                            <td style=""> {{ data.client_name }} </td>
                            ...
                            <td class="action_td action-extra">
                                <div class="actions position-relative">
                                    <div class="action_btn">
                                        <router-link
                                            v-if="$root.checkPermission('invoice.bill') && data.source === 'Invoice'"
                                            :to="{ name: 'invoice.bill', params: { id: data.id } }"
                                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Invoice"
                                            v-x-tooltip="Invoice"><span class="icon"><i
                                                    class="fa fa-money"></i></span></router-link>
                                        <router-link
                                            v-if="$root.checkPermission('bandwidthHistory.show') && data.source === 'Bandwidth'"
                                            :to="{ name: 'bandwidthHistory.show', params: { id: data.id } }"
                                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Invoice"
                                            v-x-tooltip="Invoice"><span class="icon"><i
                                                    class="fa fa-money"></i></span></router-link>
                                    </div>
