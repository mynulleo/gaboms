<template>
    <index-page :defaultTable="false" :show_status="false">
        <template v-slot:search-field>
            <v-select-container title="Select Uplink Provider" field="search_data.uplink_provider_id" col="3">
                <v-select v-model="search_data.uplink_provider_id" label="org_name" :reduce="(obj) => obj.id"
                    :options="uplinkproviders" placeholder="--Select Uplink Provider--" :closeOnSelect="true">
                </v-select>
            </v-select-container>
        ...
        <template v-slot:table-list>
            ...
            <div class="my-5" id="printArea">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h5 class="fw-bold mb-1">Uplink Provider Ledger</h5>
                        <small class="text-muted">Name: <strong>{{ datas.uplinkprovider?.org_name
                                }}</strong></small><br>
                        <small class="text-muted">Mobile: <strong>{{ datas.uplinkprovider?.mobile
                        }}</strong></small><br>
                        <small class="text-muted">Address: <strong>{{ datas.uplinkprovider?.address
                        }}</strong></small><br>
...
export default {
    data() {
        return {
            ...
            uplinkproviders: [],  // Store account heads for the select dropdown
        };
    },
    ...
    methods: {
        ...
        getUplinkProviders() {
            axios.get(
                ...
                .then((response) => {
                    this.uplinkproviders = response.data;
                })
                .catch((error) => {
                    console.error(error);
                });
        ...
        getClientLedger() {
            axios
                .get(`report/uplinkproviderledger/`, { params: this.search_data })
                .then((res) => {
                    this.datas = res.data
                })
        },
